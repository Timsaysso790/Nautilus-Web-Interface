...
import { PortfolioAssetGrid } from "@/backtest/components/PortfolioAssetGrid";
import { CashSchedulePanel } from "@/backtest/components/CashSchedulePanel";
import { ValuationClearancePanel } from "@/backtest/components/ValuationClearancePanel";
import { MarginBridgePanel } from "@/backtest/components/MarginBridgePanel";
import { VixHedgePanel } from "@/backtest/components/VixHedgePanel";
import { PortfolioContextCard } from "@/backtest/components/PortfolioContextCard";
import type {
...
export default function QuickBacktestView() {
      ...
      <div className="lg:col-span-2 space-y-4">
        {!result && !running && (
          <div className="text-center py-16 text-muted-foreground">
            <p className="text-lg">Quick Portfolio Backtest</p>
            <p className="text-sm mt-2">
              Configure your portfolio on the left and run the backtest. Results appear here —
              no project save required.
            </p>
          </div>
        )}
